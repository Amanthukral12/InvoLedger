...
import ClientTransactions from "./pages/ClientTransactions.tsx";
import AddPurchase from "./pages/AddPurchase.tsx";
import Purchases from "./pages/Purchases.tsx";
import UpdatePurchase from "./pages/UpdatePurchase.tsx";
